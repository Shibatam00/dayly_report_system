...
public interface JpaConst {
    ...
    String Q_EMP_GETALL_DEF = "SELECT e FROM Employee AS e ORDER BY e.id DESC"; //従業員idの降順に取得

    String Q_EMP_COUNT = ENTITY_EMP + ".count";
    String Q_EMP_COUNT_DEF = "SELECT COUNT(e) FROM Employee AS e"; //全従業員数
    ...
    String Q_REP_GET_ALL_MINE = ENTITY_EMP + ".getAllMine";

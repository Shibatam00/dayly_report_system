...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <fmt:parseDate value="${employee.createdAt}"
                        pattern="yyyy-MM-dd'T'HH:mm:ss" var="createDay" type="date"></fmt:parseDate>
                    <td>
                ...
                <tr>
                    ...
                    <fmt:parseDate value="${employee.updatedAt}"
                        pattern="yyyy-MM-dd'T'HH:mm:ss" var="updateDay" type="date"></fmt:parseDate>
                    <td>
        ...
        <p>
            <a
                href="<c:url value='?action=${actEmp}&command=${cmmEdit}id=${employee.id}'/>">この従業員情報を編集する</a>
        </p>
        <p>
